...
public class ControllerTests {
    ...
    * */
    ...
    @Test
    public void g1_testSignUpInvalidPassword() throws Exception {
    	// sign up and then delete the user 
    	HttpEntity<String> entity = new HttpEntity<String>(null, headers);
        ResponseEntity<String> response = restTemplate.exchange(
    ...
    @Test
    public void g2_testSignUpInvalidEmail() throws Exception {
    	// sign up and then delete the user 
    	HttpEntity<String> entity = new HttpEntity<String>(null, headers);
        ResponseEntity<String> response = restTemplate.exchange(
    ...
    @Test
    public void g3_testSignUpExistingUser() throws Exception {
